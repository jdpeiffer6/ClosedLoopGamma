classdef vizualization_tool < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function results = plotresult(app)
            ...
            switch app.BAND
                case 1
                    plot(app.UIAxes2,tt,app.SUBSET.b35p(app.T1:app.T2),tt,app.SUBSET.b35a(app.T1:app.T2))             
                case 2
                    plot(app.UIAxes2,tt,app.SUBSET.b55p(app.T1:app.T2),tt,app.SUBSET.b55a(app.T1:app.T2)) 
                case 3
                    plot(app.UIAxes2,tt,app.SUBSET.b75p(app.T1:app.T2),tt,app.SUBSET.b75a(app.T1:app.T2)) 
                case 4
                    plot(app.UIAxes2,tt,app.SUBSET.b95p(app.T1:app.T2),tt,app.SUBSET.b95a(app.T1:app.T2)) 
            end
...
%             morebins(h);
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = vizualization_tool
